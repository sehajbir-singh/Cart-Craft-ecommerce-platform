...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between font-medium py-5">
      ...
      <Link to='/'>
        <img src={assets.logo6} className="w-36" alt="" />
      </Link>
      ...
      <div className="flex items-center gap-6">
        ...
        <Link to="/cart" className="relative">
          ...
          <p className="absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 aspect-square bg-black text-white rounded-full text-[8px]">
            {getCartCount()}
          </p>
        </Link>
